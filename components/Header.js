    ...
    return (
        <div className="shadow-sm border-b bg-white sticky top-0 z-50">
            ...
            <div className="flex justify-between max-w-5xl xl:mx-auto">
                {/* Left */}
                <div onClick={() => window.location.href = '/'} className="relative hidden lg:inline-grid lg:w-24 cursor-pointer">
                    <Image
                        src={mipuLogo}
                        layout="fill"
                        objectFit="contain"
                ...
                <div onClick={() => window.location.href = '/'} className="relative w-20 lg:hidden flex-shrink-0 cursor-pointer">
                    <Image
                        src={mipuLogo}
                        layout="fill"
                        objectFit="contain"
                ...
                {session ? (
                    <>
                        <div className="flex items-center justify-end space-x-5">
                            <HomeIcon onClick={() => window.location.href = '/'} className="nav-groups-button" />
